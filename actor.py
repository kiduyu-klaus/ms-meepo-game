...
class Wall(Character):
    """
    This will create the four walls of our game
...
class Rock(Character):
    """
    This creates the rock in the game
...
class Subject(Block):
    ...
    def __init__(sellf, x: int, y: int, word_: str) -> None:
        super().__init__(x, y)
        self.word = word_
        self._is_push = True
        self._is_stop = True
